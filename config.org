...
(define-key evil-insert-state-map (kbd "M-S-h") (kbd "^"))
(define-key evil-insert-state-map (kbd "M-S-j") (kbd "&"))
(define-key evil-insert-state-map (kbd "M-S-k") (kbd "*"))
(define-key evil-insert-state-map (kbd "M-S-l") (kbd "("))
(define-key evil-insert-state-map (kbd "M-S-;") (kbd ")"))
#+end_src
